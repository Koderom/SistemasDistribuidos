 ...
 * @author MIRKO
 */
public class EliminoBarcoEvent extends EventObject{
    int fila;
    int columna;
    int size;
    char orientacion;
    ...
    public EliminoBarcoEvent(int fila, int columna, int size, char orientacion, String nick_objetivo, String nick_autor, Object source) {
        super(source);
        this.fila = fila;
